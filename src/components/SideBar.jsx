...
<ul className="flex justify-center">
          ...
          <li className="mr-12">
            <Link to='cart'
              className="text-3xl text-black font-[500] relative "
              
            >
              <div className="bg-green-600 h-5 w-5  left-5 flex justify-center items-center absolute rounded-full">
                <p className="text-white text-sm"> {cart.length}</p>
              </div>
              <GrCart size={34} color='black' />
            </Link>
          </li>
